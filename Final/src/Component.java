...
public class Component extends JFrame {
	...
	public Component() {
		 ...
		 * scoreLabel[0].setEditable(false); scoreLabel[0].setFont(new
		 * Font(scoreLabel[0].getFont().getName(),
		 * scoreLabel[0].getFont().getStyle(), 40));
		 ...
		 * 
		 * if(Main.mod.equals("battle") == true){ scoreLabel[1] = new
		 * JTextArea(); scoreLabel[1].setBackground(SystemColor.control);
		 * scoreLabel[1].setEditable(false); scoreLabel[1].setFont(new
		 * Font(scoreLabel[1].getFont().getName(),
		 * scoreLabel[1].getFont().getStyle(), 40));
		 * scoreLabel[1].setText("Score:\n" + Main.score[1]);
		 * scoreLabel[1].setSize(scoreLabel[1].getPreferredSize());
		 * scoreLabel[1].setLocation(1200, 400); add(scoreLabel[1]);
